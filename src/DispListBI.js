...
const DispListBI = () => {
  ...
  const csvHeaders = [
    ...
    { label: "購入価格", key: "RealPrice" },
    { label: "定価", key: "CatalogPrice" },
    { label: "購入場所", key: "PurchaseLocation" },
    { label: "レーベル", key: "Label" },
    { label: "分類", key: "Series" },
    { label: "出版社", key: "Publisher" },
    { label: "出版日", key: "PublicationDate" },
    { label: "著者", key: "Author" }
  ];
      ...
      console.log("item is zero.");
        ...
        for (let i = 0; i < result.length; i++) {
            ...
            csvDataTemp.push({
              ...
              RealPrice : result[i].RealPrice,
              CatalogPrice : result[i].CatalogPrice,
              PurchaseLocation : result[i].PurchaseLocation,
  ...
  function handleClick() {
    ...
    totalRealPriceRef.current.innerText = "";
    totalCatalogPriceRef.current.innerText = "";
